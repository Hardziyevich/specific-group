package com.github.akarazhev.jacademy.datastructures.stack;

import com.github.akarazhev.jacademy.datastructures.Employee;
...
final class StackTest {
    ...
    void testArrayStack() {
        ...
        Assertions.assertEquals("Bill", stack.peek().getFirstName());
        assertEquals(5, stack.size());

        Assertions.assertEquals("Bill", stack.pop().getFirstName());
        Assertions.assertEquals("Mike", stack.peek().getFirstName());
    }
